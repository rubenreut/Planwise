...
struct TaskDateFilterView: View {
    @Binding var selectedFilter: TaskListView.TaskFilter
    let taskCount: (TaskListView.TaskFilter) -> Int
    @AppStorage("taskViewDateFilterExpanded") private var isDateSelectorExpanded = true
    ...
    private var filterTitle: String {
        "\(selectedFilter.rawValue) (\(taskCount(selectedFilter)))"
    }
